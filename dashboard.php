...
<head>
    <meta charset="utf-8">
    <title>Perfil - <?php echo $_SESSION['nombres']; ?></title>
        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                <a href="" class="navbar-brand p-0">
                    <h1 class="text-primary m-0"><i class="fa fa-truck me-3"></i>Ubi App</h1>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h5 class="section-title ff-secondary text-center text-primary fw-normal">Ingresa ó Registrate</h5>
                    <h1 class="mb-5">Ingresa con tu usuario y contraseña</h1>
                </div>
                <div class="row g-4">
